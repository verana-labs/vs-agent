  ...
  properties: {
    credentialSubject: {
      ...
      properties: {
        ...
        logoUri: { type: 'string', format: 'uri', maxLength: 4096 },
        logoDigestSri: { type: 'string', maxLength: 256 },
        registryId: { type: 'string', minLength: 0, maxLength: 256 },
        registryUri: { type: 'string', minLength: 0, maxLength: 256 },
        address: { type: 'string', minLength: 0, maxLength: 1024 },
        organizationKind: { type: 'string', enum: ['PUBLIC', 'PRIVATE', 'FOUNDATION'] },
